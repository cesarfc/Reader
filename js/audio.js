...
RR.audio = (function () {
  ...
  const sfx = {
    ...
    ding()    { tone(660, 0, 0.12); tone(880, 0.1, 0.18); },
    buzz()    { tone(140, 0, 0.2, 'square', 0.08); },
    star()    { [523, 659, 784, 1047].forEach((f, i) => tone(f, i * 0.09, 0.16, 'triangle', 0.2)); },
    fanfare() { [523, 659, 784, 1047, 1319].forEach((f, i) => tone(f, i * 0.12, 0.22, 'triangle', 0.2)); },
    ...
    hit()     { tone(220, 0, 0.1, 'square', 0.12); tone(110, 0.03, 0.16, 'sawtooth', 0.1); },
    ...
    hurt()    { tone(196, 0, 0.18, 'sawtooth', 0.1); tone(147, 0.12, 0.22, 'sawtooth', 0.09); },
    victory() { [523, 523, 523, 659, 784, 1047].forEach((f, i) => tone(f, i * 0.11, 0.18, 'triangle', 0.2)); },
