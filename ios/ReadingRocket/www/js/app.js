...
(function () {
  ...
  const GAME_SECTIONS = [
    ...
    { label: '📝 Words & spelling', ids: ['spell', 'memory', 'morph', 'twins', 'review', 'rescue', 'sight'] },
  ...
  /* Three picks, with due review first, then date-seeded skill sections. */
  ...
  function renderPlayTab() {
    ...
    const available = id => {
      const g = RR.games[id];
      return g &&
        (!g.grades || g.grades.includes(p.grade)) &&
